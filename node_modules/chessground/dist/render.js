...
export function updateBounds(s) {
    ...
    (_b = s.addDimensionsCssVarsTo) === null || _b === void 0 ? void 0 : _b.style.setProperty('---cg-width', width + 'px');
    (_c = s.addDimensionsCssVarsTo) === null || _c === void 0 ? void 0 : _c.style.setProperty('--cg-height', height + 'px');
    (_d = s.addDimensionsCssVarsTo) === null || _d === void 0 ? void 0 : _d.style.setProperty('---cg-height', height + 'px');
}
