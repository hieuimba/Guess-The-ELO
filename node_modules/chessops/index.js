export { FILE_NAMES, RANK_NAMES, COLORS, ROLES, CASTLING_SIDES, isDrop, isNormal, RULES, } from './types.js';
...
export { Material, MaterialSide, RemainingChecks, defaultSetup } from './setup.js';
export { IllegalSetup, Castles, Chess, Position, PositionError } from './chess.js';
