...
import { PositionError, Position, IllegalSetup, Chess, Castles, castlingSide, equalsIgnoreMoves, normalizeMove, isStandardMaterialSide, pseudoDests, } from './chess.js';
export { Position, PositionError, IllegalSetup, Chess, Castles, equalsIgnoreMoves, castlingSide, normalizeMove, };
...
export const setupPosition = (rules, setup, opts) => {
    switch (rules) {
        case 'chess':
